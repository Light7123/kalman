...
const uint8_t MEDIAN_FILTER_SIZE = 15;		// размер медианного фильтра!
...
public:
	...
	float filteredAdapt(int32_t value,int diff);// возвращает фильтрованное значение, применяя адаптивный коэффициент
	...
	float filteredAdapt(float value,float diff);// возвращает фильтрованное значение, применяя адаптивный коэффициент
...
public:
	GMedian3();
	int filtered(long value);	// возвращает фильтрованное значение
